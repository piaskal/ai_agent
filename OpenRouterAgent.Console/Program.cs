...
using OpenRouterAgent.ConsoleApp.Agent.Tools.Foodwarehouse;
...
try
{
	...
	builder.Services.AddSingleton<IAgentTool, FoodwarehouseHelpTool>();
	builder.Services.AddSingleton<IAgentTool, FoodwarehouseOrdersTool>();
	builder.Services.AddSingleton<IAgentTool, FoodwarehouseSignatureGeneratorTool>();
	builder.Services.AddSingleton<IAgentTool, FoodwarehouseDoneTool>();
